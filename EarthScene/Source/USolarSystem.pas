...
(*
  TSystemData = record
   ...
   TSunData = record   // Also Equal to material texture
     {NOT 8.3 NAME only  Extension ADDED ..ONLY .jpg Expected: .bmp  .tif  .tga .png ignored}
      SunName          : String[255] ;
      Radius           : Double;
...
type
   ...
   {The whole point is these are used to compute the ABOVE.. Depending on the CURRENT TIME}
